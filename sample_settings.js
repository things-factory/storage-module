...
module.exports = {
  ...
  // lost.
  credentialSecret: 'things-factory-operato-ecs',
  ...
  adminAuth: {
    sessionExpiryTime: Infinity,
    type: 'credentials',
    users: [
      {
        username: 'admin',
        password: '$2b$08$DEXia6kI7e6gCw5nMHe5LOH0TarMVN5809pzpPsgG5qRvUp.cX8aC',
        permissions: '*'
      }
    ]
  },
  ...
  storageModule: require('./storage-module'),
  ...
  thingsFactory: {
    ...
    user: {
      ...
      password: 'admin',
      // username: 'ms@hatiolab.com',
      // password: 'ms',
      domain: '2d5991bf-384a-4467-8e11-de93ce564581'
    }
  },
